...
faqSchema:
  ...
  - question: "How does Florida's comparative fault rule affect my case?"
    answer: "Florida uses a modified comparative fault system with a 50% bar rule. If you are found more than 50% at fault, you cannot recover any damages. If 50% or less at fault, your recovery is reduced proportionally by your fault percentage."
...
### How Florida's 50% Bar Rule Works in Practice
...
Florida's comparative fault statute is codified at [Florida Statute § 768.81](https://www.leg.state.fl.us/Statutes/index.cfm?App_mode=Display_Statute&URL=0700-0799/0768/Sections/0768.81.html).

**A real-world example:** Suppose you are injured in a collision at a Jacksonville intersection. A jury finds the other driver ran a red light but also finds you were speeding. If the jury assigns you 30% of the fault and awards $100,000 in total damages, you receive $70,000. But if the jury assigns you 55% of the fault, you receive $0 — regardless of how seriously you were injured.

This is why insurance companies aggressively argue comparative fault in Florida cases. Pushing your fault percentage above 50% eliminates their entire liability. An experienced [Jacksonville car accident attorney](/car-accident/fl/jacksonville) or [Miami car accident attorney](/car-accident/fl/miami) can counter these tactics and protect your recovery.
...
Evidence of breach can also include [NHTSA traffic safety data](https://www.nhtsa.gov/research-data/fatality-analysis-reporting-system-fars) when federal safety standards are relevant to the claim.

An experienced attorney builds the evidentiary case to establish clear breach and counter the defense's fault and causation arguments. If you were injured in a Jacksonville car accident, a [Jacksonville car accident attorney](/car-accident/fl/jacksonville) can evaluate the four elements as they apply to your specific facts. For Miami-area accidents, connect with a [Miami car accident attorney](/car-accident/fl/miami).
...
Florida uses a modified comparative fault system with a 50% bar rule. If you are found more than 50% at fault, you cannot recover any damages. If you are 50% or less at fault, your recovery is reduced proportionally by your fault percentage. Insurance companies actively work to push your assigned fault above 50% to eliminate their liability entirely.

### What is the difference between comparative and contributory negligence?
Comparative negligence reduces your recovery by your percentage of fault but still allows recovery below the threshold. Contributory negligence (used in Alabama, Maryland, Virginia, North Carolina, and D.C.) is far harsher — if you are even 1% at fault, you recover nothing. Florida uses modified comparative fault, not contributory negligence.
