...
faqSchema:
  ...
  - question: "How are pain and suffering damages calculated?"
    answer: "Courts and insurance companies most commonly use the multiplier method — multiplying total economic damages by a factor between 1.5 and 5 based on injury severity. The per diem method assigns a daily dollar value for each day of suffering."
  ...
  - question: "When are punitive damages available?"
    answer: "Punitive damages require clear and convincing evidence of intentional misconduct or gross negligence. Most states cap punitive damages, commonly at two to four times compensatory damages or a fixed dollar amount. They are not available in every case."
