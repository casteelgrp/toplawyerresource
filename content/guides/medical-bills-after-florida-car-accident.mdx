...
<div style={{margin: '1rem 0'}}>
  <a href="/tools/settlement-calculator" style={{display:'inline-block',padding:'12px 20px',borderRadius:'8px',border:'1px solid #d1d5db',fontSize:'14px',fontWeight:'500',textDecoration:'none',color:'#111827',backgroundColor:'#f9fafb'}}>
    See how liens affect your payout - Try the Settlement Calculator
  </a>
</div>
